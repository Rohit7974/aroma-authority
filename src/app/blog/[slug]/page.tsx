        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 mt-6">
          ...
          <div className="lg:col-span-8 space-y-8">
            ...
            {post.keyTakeaways && post.keyTakeaways.length > 0 && (
              <section
                ...
                className="p-6 bg-stone-50 dark:bg-stone-900/30 border-l-4 border-accent rounded-r-lg"
              >
                <h2 className="text-xs uppercase tracking-widest font-sans font-bold text-accent mb-3 flex items-center gap-2">
                  <span>Key Takeaways</span>
                </h2>
                <ul className="space-y-2 text-sm text-muted dark:text-stone-300 font-sans leading-relaxed list-disc pl-5">
                ...
                <div className="divide-y divide-border/60">
                  {post.faqs.map((faq, idx) => (
                    <details key={idx} className="py-4 group focus-within:text-accent">
                      ...
                      <p className="text-sm font-sans text-muted dark:text-stone-300 mt-2 leading-relaxed pl-1">
                        {faq.answer}
                      </p>
                    </details>
                  ))}
            ...
            <div className="flex justify-between items-center gap-4 py-8 border-t border-border/40">
              {prevPost ? (
                <Link
                  ...
                  className="flex-1 text-left p-4 border border-border/60 hover:border-accent rounded-lg bg-stone-50/50 dark:bg-stone-900/10 focus:outline-none focus:ring-2 focus:ring-accent transition-all"
                >
              ...
              {nextPost ? (
                <Link
                  ...
                  className="flex-1 text-right p-4 border border-border/60 hover:border-accent rounded-lg bg-stone-50/50 dark:bg-stone-900/10 focus:outline-none focus:ring-2 focus:ring-accent transition-all"
                >
                  <span className="text-[10px] uppercase tracking-widest font-sans text-muted-light block mb-1">
                    Next Article →
                  </span>
          ...
          <aside className="hidden lg:col-span-4 lg:block space-y-8">
            ...
            {relatedPosts.length > 0 && (
              <div className="p-6 border border-border/80 rounded-lg bg-white dark:bg-stone-900 luxury-shadow">
